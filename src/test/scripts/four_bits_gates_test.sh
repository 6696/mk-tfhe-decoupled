...
cd client1
../mk_tfhe_client-spqlios-fma e 100000
cd ..

# B
# create encrypted string for client 2
cd client2
../mk_tfhe_client-spqlios-fma e 010000
cd ..

# create encrypted string for client 3
cd client3
../mk_tfhe_client-spqlios-fma e 001000
cd ..

# create encrypted string for client 4
cd client4
../mk_tfhe_client-spqlios-fma e 000100
cd ..
...
./mk_tfhe_gates_test-spqlios-fma c .
